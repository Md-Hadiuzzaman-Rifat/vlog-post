...
//         <h2 className="text-4xl md:text-6xl font-bold text-gray-500 my-10">&gt; NewsFeed</h2>
//         {
//             data.map((item)=><div key={Math.random}className="newsFeed_content_item gap-4 flex flex-col md:flex-row md:items-center">
//             <div className="newsFeed_Image">
//                 <Image src={item.image} className="object-cover max-w-[300px] min-w-[200px] h-[300px]" width={250} height={400} alt={item.title} ></Image>
//             </div>
